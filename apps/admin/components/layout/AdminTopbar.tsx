...
import { getAdminProfile } from "@/modules/auth/api";
import type { AdminProfile } from "@/modules/auth/types/admin-auth.type";
...
export function AdminTopbar({ onMenuClick }: AdminTopbarProps) {
  ...
  const [profile, setProfile] = useState<AdminProfile | null>(() => {
    ...
    return cachedProfile ? (JSON.parse(cachedProfile) as AdminProfile) : null;
  });
