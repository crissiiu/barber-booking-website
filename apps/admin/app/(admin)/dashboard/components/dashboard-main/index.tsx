import { getBookingStatusTone } from "@admin/dashboard/constants/dashboard-constants";
              ...
              <TableBody>
                {recentBookings.map((booking) => (
                  <TableRow key={booking.id}>
                    ...
                    <TableCell>
                      <StatusBadge tone={getBookingStatusTone(booking.status)}>
                        {booking.status}
                      </StatusBadge>
                    </TableCell>
                  </TableRow>
          ...
          <CardContent>
            <ol className="space-y-4">
              {activityFeed.map((activity) => (
                <li
                  className="border-l-2 border-primary-soft pl-3 text-sm leading-6 text-slate-600"
                  key={activity}
                >
                  {activity}
                </li>
