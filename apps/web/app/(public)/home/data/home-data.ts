...
export const hairServices: MarketingItem[] = [
  {
    description: "Tư vấn form tóc phù hợp khuôn mặt, cắt, gội sấy và tạo kiểu hoàn thiện.",
    id: "haircut",
    image: "/services/cat-toc.png",
    minPrice: 100000,
    title: "Cắt tóc chuẩn Barber",
  },
  {
    description: "Định hình nếp tóc uốn phồng, xoăn sóng hoặc xù nhẹ tự nhiên.",
    id: "perm",
    image: "/services/uon-dinh-hinh.png",
    minPrice: 250000,
    title: "Uốn định hình cao cấp",
  },
  {
    description: "Nhuộm màu công sở, thời trang với dòng thuốc bảo vệ da đầu.",
    id: "color",
...
export const careServices: MarketingItem[] = [
  {
    description: "Gội đầu thư giãn kết hợp massage cổ vai gáy giải tỏa căng thẳng.",
    id: "shampoo",
  ...
  {
    description: "Lấy rấy tai êm ái với bộ dụng cụ tiệt trùng chuyên nghiệp.",
    id: "ear-clean",
    image: "/services/lay-ray-tai.png",
    minPrice: 60000,
    title: "Lấy rấy tai thư giãn",
  },
  {
    description: "Chăm sóc da mặt chuyên sâu, hút mụn cám và đắp mặt nạ cấp ẩm.",
    id: "skincare",
